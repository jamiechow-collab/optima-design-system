...
export const SizesExample = () => (
  <div style={{ ...card, gap: 32 }}>
    <div style={example}>
      <span style={exampleLabel}>sm</span>
      <Badge size="sm">Badge</Badge>
    </div>
    <div style={example}>
      <span style={exampleLabel}>md</span>
      <Badge size="md">Badge</Badge>
    </div>
    <div style={example}>
      <span style={exampleLabel}>lg</span>
...
export const VariantsExample = () => (
  <div style={{ ...card, flexDirection: 'column', alignItems: 'flex-start', gap: 16 }}>
    ...
    <div style={{ ...example, gap: 8 }}>
      <span style={exampleLabel}>With icon (common icons would be dots, close, arrows)</span>
